...
export default function PackageCalculator() {
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="border-b fixed top-0 left-0 right-0 border-border z-50 backdrop-blur-3xl">
      ...
      <div className="max-w-7xl mt-10 mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Transparent pricing for professional web solutions. All prices in
            Ethiopian Birr (ETB).
          </p>
        </div>
