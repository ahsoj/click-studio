...
export default function WebDevelopment() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Built to grow with your business using best practices and clean code",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Security First",
      description:
        "Implemented with security best practices to protect your data",
    },
  ];
      ...
      <section className="pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12 leading-relaxed">
            We develop robust, scalable web applications using cutting-edge
            technologies. From simple websites to complex web applications, we
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-brand-white">Development </span>
      ...
      <section className="py-20 bg-gradient-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-brand-dark mb-8 max-w-2xl mx-auto">
            Ready to bring your web application idea to life with modern
          ...
          >
            <a href="/transparent-pricing-calculator">Start Your Project</a>
          </Button>
        </div>
      </section>
    </div>
